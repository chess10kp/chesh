...
const PIECE_PIXELS: Record<PieceType, number[]> = {
  pawn: [
    47, 57, 46, 56, 35, 45, 55, 65, 44, 54, 43, 53, 32, 42, 52, 62, 21, 31, 41,
    51, 61, 71,
  ],
  rook: [
    21, 31, 41, 51, 61, 71, 22, 32, 42, 52, 62, 72, 33, 43, 53, 63, 34, 44, 54,
    64, 35, 45, 55, 65, 26, 36, 46, 56, 66, 76, 27, 47, 57, 77,
  ],
  bishop: [
    47, 57, 46, 36, 35, 45, 55, 65, 44, 54, 43, 53, 32, 42, 52, 62, 21, 31, 41,
    51, 61, 71,
  ],
  knight: [
    47, 57, 36, 46, 56, 66, 25, 35, 45, 55, 65, 24, 34, 44, 54, 64, 43, 53, 63,
    32, 42, 52, 62, 21, 31, 41, 51, 61, 71,
  ],
  queen: [
    47, 57, 26, 46, 56, 76, 25, 35, 45, 55, 65, 75, 34, 44, 54, 64, 43, 53, 32,
    42, 52, 62, 21, 31, 41, 51, 61, 71,
  ],
  king: [
    21, 31, 41, 51, 61, 71, 32, 42, 52, 62, 23, 33, 43, 53, 63, 73, 24, 34, 44,
    54, 64, 74, 45, 55, 36, 46, 56, 66, 47, 57,
  ],
};
...
export function renderPixelArtPiece(
  color: PieceColor,
  type: PieceType
): string {
